...
<!-- badges: start -->
[![R-CMD-check: Master](https://github.com/Claudius-Appel/duflor/actions/workflows/R-CMD-check.yaml/badge.svg?branch=master)](https://github.com/Claudius-Appel/duflor/actions/workflows/R-CMD-check.yaml)
...
The function [load_all()] can optionally load subsets of an image; for more information see its documentation.
To allow this to work, the package [RBioFormats](https://github.com/aoles/RBioFormats) is required. Refer to its documentation for installing the package.
