...
2. Define the HSV-spectrums to quantify. (You may either define them yourself, or modify default-spectrums loaded by `spectrums <- getOption("duflor.default_hsv_spectrums")`)
